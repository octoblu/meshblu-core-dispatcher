...
class TaskRunner
  @TASKS =
    ...
    'meshblu-core-task-create-session-token'               : require('meshblu-core-task-create-session-token')
    'meshblu-core-task-create-subscription'                : require('meshblu-core-task-create-subscription')
    ...
    'meshblu-core-task-get-broadcast-subscription-types'   : require('meshblu-core-task-get-broadcast-subscription-types')
    ...
    'meshblu-core-task-get-status'                         : require('meshblu-core-task-get-status')
    ...
    'meshblu-core-task-revoke-session-token'               : require('meshblu-core-task-revoke-session-token')
